    ...
    <div>
      {cart.length > 0 ? (
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center">
          <div class="w-[100%] md:w-[60%] flex flex-col p-2 mt-2 md:p-5">
            {cart.map((item, index) => {
        ...
        <div className="flex flex-col items-center justify-center min-h-[80vh]  ">
          ...
          <Link to="/">
            <button
              className=" bg-green-600 hover:bg-purple-50 text-white  
              tracking-wider font-semibold transition duration-300 ease-linear
            uppercase p-3 px-10 rounded-lg hover:text-green-700 mt-5 border-2  border-green-600"
            >
              Shop Now
            </button>
          </Link>
